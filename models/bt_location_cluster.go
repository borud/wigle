...
// Validate validates this bt location cluster
func (m *BtLocationCluster) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BtLocationCluster) validateLocations(formats strfmt.Registry) error {
...
func (m *BtLocationCluster) validateMaxLastUpdate(formats strfmt.Registry) error {
...
func (m *BtLocationCluster) validateMinLastUpdate(formats strfmt.Registry) error {
...
func (m *BtLocationCluster) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BtLocationCluster) contextValidateLocations(ctx context.Context, formats strfmt.Registry) error {
