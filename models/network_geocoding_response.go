...
// Validate validates this network geocoding response
...
func (m *NetworkGeocodingResponse) validateResults(formats strfmt.Registry) error {
...
func (m *NetworkGeocodingResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NetworkGeocodingResponse) UnmarshalBinary(b []byte) error {
	var res NetworkGeocodingResponse
